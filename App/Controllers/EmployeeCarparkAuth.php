 ...
 * PHP version 7.0
 */ 
abstract class EmployeeCarparkAuth extends Authenticated
{
    /**
    ...
    {
        if ($this->user->user_role_id != UserRole::ROLE_CARPARK) {

            FlashMessage::add('Parkhaus Mitarbeiterrolle erforderlich', FlashMessage::INFO);
